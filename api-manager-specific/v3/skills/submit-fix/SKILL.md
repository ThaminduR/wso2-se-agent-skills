...
1. **Read all phase artifacts.** Before creating the PR, read the output from every prior phase so you can include a comprehensive summary in the fix report and PR description:
   - `.ai/issue-analysis-<issue_number>.md` — issue analysis from reproduce phase
   ...
   - `.ai/fix-verification-report.md` — verification results
...
### Reproduction
<Summary from .ai/issue-analysis-<issue_number>.md>
...
### Verification
<Summary from .ai/fix-verification-report.md>
