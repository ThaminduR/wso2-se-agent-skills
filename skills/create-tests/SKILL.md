---
name: create-tests
description: Write unit and integration tests for a reproduced bug based on ia-<issue_number>.md.
user-invocable: true
argument-hint: "[path to ia-<issue_number>.md]"
---
...
## Step 1: Understand the Bug from `ia-<issue_number>.md`
